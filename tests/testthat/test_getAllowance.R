...
test_that("getAllowance() works", {
  expect_equal(sum(getAllowance(tempEmp1)$cost), 1100 * 12)
  expect_equal(sum(getAllowance(tempEmp2)$cost), 4100 * 11)
  expect_equal(sum(getAllowance(tempEmp3)$cost), 4000 * 10)
  expect_equal(sum(getAllowance(tempEmp4)$cost), 1800 * 9)
  expect_equal(sum(getAllowance(tempEmp5)$cost), 0)
})
