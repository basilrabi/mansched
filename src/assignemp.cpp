                            ...
                            bool selfAssign = false )
{
  ...
  if ( empClass == "Operator" )
  {
    ...
    Rcpp::DataFrame mhdbEmp = mhdbInitEmployee( mhTypeC, empR.slot( "ID" ), empT.slot( "ID" ), empT.slot( "costCenter" ) );
  ...
  {
    Rcpp::DataFrame mhdbEmp = mhdbInitEmployee( mhTypeB, empR.slot( "ID" ), empT.slot( "ID" ), empT.slot( "costCenter" ) );
  ...
  {
    Rcpp::DataFrame mhdbEmp = mhdbInitEmployee( mhTypeA, empR.slot( "ID" ), empT.slot( "ID" ), empT.slot( "costCenter" ) );
